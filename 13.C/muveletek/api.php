...
{
    switch ($apiParts[0]) {
        case 'osszead': include_once("includes/osszead.php");
        echo osszead($apiParts); break;
        case "kivon" : include_once("includes/kivon.php");
        echo kivonas($apiParts); break;
        case "szoroz" : include_once("includes/szoroz.php");
        echo szoroz($apiParts); break;
        case "oszt" : include_once("includes/oszt.php");
        echo oszt($apiParts); break;
        default:
            echo sprintf($GLOBALS["lang"]["ismeretlen művelet: %s "], $apiParts[0]);
